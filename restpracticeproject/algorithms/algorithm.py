...
class VNS():
    ...
    def __init__(self, salesman_number, city_number, distance_matrix, exclusive_cities, shared_cities):
    ...
    def greedy_initialization(self):
        ...
        min_route_lengths = [10000000] * self.salesman_number
    ...
    def local_search(self, x:list[list]):
        ...
        for i in range(len(exclusive_S)):
            for j in range(len(exclusive_S[i])):
                min_length = [10000000] * self.salesman_number
